...
class App extends Component {
  constructor() {
    ...
    this.state = {
      ...
      projAd:
        "จัดการค่าใช้จ่ายภายในกลุ่ม แบบ realtime ด้วย DivideGoose คุณสามารถสร้างห้อง และ ให้เพื่อนๆของคุณร่วมกันแก้ไขข้อมูลค่าใช้จ่ายต่างๆ และ ได้ข้อมูลว่าทุกคนในกลุ่มของคุณควรจะจ่ายเท่าไหร่ ลดปัญหาการทะเลาะกันในกลุ่มคุณว่าจริงๆควรจะจ่ายกันเท่าไหร่กันแน่",
      basicMod: [
